...
const BookHotelSection = () => {
  ...
  const postData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Handle errors here, e.g., set an error message
        const data = await response.json();
  ...
  return (
    ...
    >
      ...
      <div
        id="join-waitlist"
        className="bg-brand-blue p-4  lg:p-12  absolute     rounded-md sm:left-[10%] left-4 right-4 sm:right-[10%] lg:left-[20%] lg:right-[20%] "
      >
        <div className="w-full items-center justify-center flex flex-col space-y-4">
          ...
          <div className="">
            ...
            >
              ...
              >
                {/* {loading ? "Loading" : "Join Waitlist"}*/}Join Waitlist
              </button>
            </form>
